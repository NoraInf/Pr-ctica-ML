...
El **Modelo AIC es estadísticamente superior** y nuestra opción definitiva. 
...
```{r warning=FALSE, message=FALSE, echo=FALSE}
# Librerías necesarias para estética y maquetación/ Las incluímos de nuevo debido a errores
library(MASS)
library(broom)
library(knitr)
library(kableExtra)
