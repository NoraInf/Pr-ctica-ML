...
r2_ajustado <- summary(modelo_refinado_bc)$adj.r.squared
...
r2_ajustado <- summary(modelo_extra_final)$adj.r.squared

cat(sprintf("Nota analítica: El número de condición final (kappa) del modelo es de %.2f y el R-cuadrado ajustado es de %.4f.\n", kappa_final, r2_ajustado))
```
**Conclusión Final: **
